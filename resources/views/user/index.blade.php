                ...
                <thead class="border-b rounded-t-lg text-left">
                  <tr>
                    ...
                    <th scope="col" class="rounded-tr-lg text-sm font-medium px-6 py-4">
                      <a href="{{ route('user.create')}}" class="text-blue-600 hover:text-blue-700 focus:text-blue-700 active:text-blue-800 transition duration-300 ease-in-out mr-4">TAMBAH</a>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr class="border-b">
                    ...
                    <td class="text-sm font-normal px-6 py-4 whitespace-nowrap text-left text-gray-500">{{ $item['email'] }}</td>
                    <td class="text-sm font-normal px-6 py-4 whitespace-nowrap text-left text-gray-500">{{ $item['role'] }}</td>
                    <td class="text-sm font-normal px-6 py-4 whitespace-nowrap text-right flex">
                      <div>
                        <a href="{{ route('user.edit', $item['id']) }}" class="font-medium text-blue-600 hover:text-blue-700 focus:text-blue-700 active:text-blue-800 transition duration-300 ease-in-out mr-4">Edit</a>
                      </div>
